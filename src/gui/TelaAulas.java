...
public class TelaAulas extends JFrame {
	...
	private JTextField txtCargaHorario;
	...
	private JTextField txtInicioCurso;
	private JTextField txtTerminoCurso;
...
//		vamos instanciar as nossas classes para gerar objetos dos itens relacionados a aula
		...
		txtCargaHorario = new JTextField();
		txtCargaHorario.setBounds(140, 42, 208, 20);
		panel_curso.add(txtCargaHorario);
		txtCargaHorario.setColumns(10);
		
		JLabel lblCargaHorria_1 = new JLabel("preço:");
		...
		txtInicioCurso = new JTextField();
		txtInicioCurso.setColumns(10);
		txtInicioCurso.setBounds(96, 46, 120, 20);
		panel_aulas.add(txtInicioCurso);
		...
		txtTerminoCurso = new JTextField();
		txtTerminoCurso.setColumns(10);
		txtTerminoCurso.setBounds(302, 46, 120, 20);
		panel_aulas.add(txtTerminoCurso);
		...
		label.setBounds(10, 81, 169, 14);
		panel_aulas.add(label);
...
//				copiar o texto que esta em titulo curso e adiciona a caixa curso
				txtCurso.setText(txtTituloCurso.getText());
				
//				vamos adicionar os elementos do curso ao objeto curso
	   ...
	   //vamos desativar o pinel de curso vamos usar o comando enabled(habilitar) com o valor false
				txtTituloCurso.setEnabled(false);
				txtCargaHorario.setEnabled(false);
